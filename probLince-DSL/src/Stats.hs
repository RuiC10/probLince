...
sampleVar :: Int -> Prob (Either RunException (Memory, Trj)) -> IO (Either String (Map String [Double]))
...
sampleTime :: Int -> Prob (Either RunException (Memory, Trj)) -> IO (Either String [Double])
...
sampleTrj :: Int -> Double -> Prob (Either RunException (Memory, Trj)) -> IO (Either String ([Map String [[(Int, Double)]]]))
