...
heatUp :: PreM ()
heatUp = rand' >>= (\v -> sequential' (untilC' (simDEvent turnOn 0.1) condOff) (simDEvent turnOn v))

coolDown :: PreM ()
coolDown = rand' >>= (\v -> sequential' (untilC' (simDEvent turnOff 0.1) condOn) (simDEvent turnOff v)) 
